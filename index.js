...
ⓁⓃˡᵘⁱˢ = [`59160189030@s.whatsapp.net`] 
prefix = '.'
blocked = []
fake = '༊ⓁⓃˡᵘⁱˢ࿑'
...
Bienvenido a ${mdata.subject}_Hola soy ⓁⓃBot
Es grato para nosotros darte la bienvenida y agradecerte por preferir ser parte de esta comunidad😊
Es una gran satisfacción tenerte de nuestro lado, espero disfrutes del grupo👥💙
...
if (!isRegistered) return reply(ind.noregis())			  
            ...
            cnf.sendMessage(from,media,image,{quoted:mek,caption:'༊ⓁⓃˡᵘⁱˢ𝕭𝖔ྂ𝖙࿆࿑'})
            }
            )
            .catch((error) => {
            console.log(error); 
...
if (jmokiuo < 30) return reply(`𝐋𝐨 𝐬𝐢𝐞𝐧𝐭𝐨 𝐜𝐨𝐢𝐧𝐬 ??𝐧𝐬𝐮𝐟𝐢𝐜𝐢𝐞𝐧𝐭𝐞𝐬.`)
confirmATM(sender, 30)
...
if (!isRegistered) return reply(ind.noregis())			  
                if (!mek.key.fromMe) return reply('*𝐬𝐨𝐥𝐨 𝐪𝐮𝐢𝐞𝐧 𝐝𝐞𝐬𝐚𝐫𝐫𝐨𝐥𝐥𝐨 𝐞𝐥 𝐛𝐨𝐭 𝐩𝐮𝐞𝐝𝐞 𝐮𝐬𝐚𝐫 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐚𝐦𝐢𝐤𝐨 𝐮𝐧𝐮*')
	        await cnf.sendMessage(from, `Bye...\n_༊ⓁⓃˡᵘⁱˢ𝕭𝖔ྂ𝖙࿆࿑ apagandose..._`, text,{quoted : freply})
		await sleep(3000)
                cnf.close()
		addFilter(from)
          break
...
if (!isRegistered) return reply(ind.noregis())			  
				if (mek.message.extendedTextMessage != undefined){
					...
					cnf.sendMessage(from, thumb, MessageType.image, {quoted: mek, caption: `༊ⓁⓃˡᵘⁱˢ𝕭𝖔ྂ𝖙࿆࿑`})}
				addFilter(from)
          break
...
if (!isRegistered) return reply(ind.noregis())			  	
				...
				buffer = fs.readFileSync(ran)
				cnf.sendMessage(from, buffer, image, {quoted: mek, caption: '༊ⓁⓃˡᵘⁱˢ𝕭𝖔ྂ𝖙࿆࿑'})
				fs.unlinkSync(ran)
			    })
...
• Limit: ${limitawal-updated.limit}`
          ...
          break
                ...
                addKoinUser('+59160189030@s.whatsapp.net', fee)
...
case prefix+'tagall2':
				...
				cnf.updatePresence(from, Presence.composing) 
					...
					cnf.sendMessage(from, 'Mencionando a todos OwO'+teks+'✪ ༊ⓁⓃˡᵘⁱˢ𝕭𝖔ྂ𝖙࿆࿑ ✪', text, {quoted: mek})
					addFilter(from)
          break
                case prefix+'tagall3':
                case prefix+'marcar3':
